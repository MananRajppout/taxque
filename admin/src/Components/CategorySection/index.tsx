...
//components
import SingleImageUpload from "../ImageHandler";
import { AppOrangeBtn, AppHoloBtn, AppBtn } from "../AppButton";
import { Loader, GoTop, DropBox, CategoryTypeList } from "../Tools";
...
export default function CategorySection() {
  ...
  const handleLocalUpdatePropertyVal = (
    ...
    const { name, value } = e.target;
    setLocalUpdateServiceData((prevData) => ({
      ...prevData,
      [name]: value,
    }));
  };
  ...
  return (
    <>
      <div
        className={
          ActivePage === "Category" ? "mainBox mainBoxActive" : "mainBox"
        }
      >
        {/* Loader */}
        ...
        {status === "error" ? (
          ...
          <div className="sectionOutBox">
            <h2 style={{ marginBottom: "20px" }}>Category list</h2>
            {/* ------------------------Create service--------------------------------- */}
            {/* ------------------------Create service--------------------------------- */}
            {/* ------------------------Create service--------------------------------- */}
            {/* ------------------------Create service--------------------------------- */}
              ...
              <div className="categoryEditView">
                ...
                <div className="ctgTextBox">
                  <div className="inputTwoBox">
                    ...
                    <div className="inToIn">
                      <p className="inputLabel">Category Type</p>
                      <DropBox
                  ...
                  />
                  <p className="inputLabel">Image Alt Tag</p>
                  <input
                    className="inputField"
                    type="text"
                    name="imgAltTag"
                          ...
                          <div className="categoryEditView">
                            ...
                            <div className="ctgTextBox">
                              ...
                              {/* <textarea
                                ...
                                value={
                                  i === updateIndex
                                    ? localUpdateServiceData?.summary
                                    : el?.summary
                                }
                                onChange={handleLocalUpdatePropertyVal}
                              /> */}
