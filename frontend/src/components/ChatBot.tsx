          ...
          <div className="bg-gray-100 border-t border-gray-200">
            ...
            <div className="px-4 py-2 flex items-center justify-center gap-1">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-gray-600 text-xs font-medium">chatway</span>
              </div>
            </div>

            {/* Navigation Tabs */}
            <div className="flex border-t border-gray-200">
              <button className="flex-1 flex flex-col items-center justify-center py-3 bg-orange-500 text-white transition-colors">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
              ...
              <button className="flex-1 flex flex-col items-center justify-center py-3 bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
