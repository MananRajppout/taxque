...
// Service data for GST Return
const gstReturnServices = [
  {
    title: "GSTR-1 Filing",
    basicPrice: "4599",
    price: "2999",
  ...
  },
  {
    ...
    period: "quarter",
    rating: 4.8,
    description: "Quarterly return for composition taxpayers"
  },
  {
    title: "GSTR-5 Filing",
    basicPrice: "4599",
    ...
    period: "month",
    rating: 4.8,
    description: "Monthly return for non-resident taxable persons"
  },
  {
    title: "GSTR-6 Filing",
    basicPrice: "4599",
    ...
    period: "month", 
    rating: 4.8,
    description: "Monthly return for input service distributors"
  },
  {
    title: "GSTR-7 Filing",
    basicPrice: "4599",
    ...
    period: "month",
    rating: 4.8,
    description: "Monthly return for TDS (Tax Deducted at Source)"
  },
  {
    title: "GSTR-8 Filing",
    basicPrice: "4599",
    ...
    period: "month",
    rating: 4.8,
    description: "Monthly return for TCS (Tax Collected at Source)"
  },
  {
    title: "GSTR-9 Filing",
    basicPrice: "4599",
      ...
      <div className="px-4 md:px-8 lg:px-16 pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {gstReturnServices.map((service, index) => (
