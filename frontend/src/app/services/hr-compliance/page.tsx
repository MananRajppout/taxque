...
// Service data for HR Compliance
const hrComplianceServices = [
  {
    ...
    period: "contract",
    rating: 4.8,
    description: "Professional employee contract drafting and legal documentation"
  },
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Comprehensive HR policy development and implementation"
  },
  {
    ...
    period: "year",
    rating: 4.8,
    description: "Complete labor law compliance and documentation services"
  },
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Professional employee handbook creation and customization"
  },
  {
    ...
    period: "audit", 
    rating: 4.8,
    description: "Comprehensive HR audit and compliance assessment"
  },
  {
    ...
    period: "year",
    rating: 4.8,
    description: "Workplace safety compliance and documentation services"
  },
  {
    ...
    period: "year",
    rating: 4.8,
    description: "Employee benefits management and compliance services"
  },
  {
    ...
    period: "program",
    rating: 4.8,
    description: "HR training programs and development workshops"
  }
];
      ...
      <div className="px-4 md:px-8 lg:px-16 pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {hrComplianceServices.map((service, index) => (
