...
const patentServices = [
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Complete patent filing and registration services"
  },
  {
    title: "Patent Search", 
    basicPrice: "4599",
    ...
    period: "search",
    rating: 4.8,
    description: "Comprehensive patent search and prior art analysis"
  },
  {
    ...
    period: "draft",
    rating: 4.8,
    description: "Professional patent specification drafting services"
  },
  {
    ...
    period: "case",
    rating: 4.8,
    description: "Patent prosecution and examination response services"
  },
  {
    ...
    period: "renewal", 
    rating: 4.8,
    description: "Patent renewal and maintenance services"
  },
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Patent assignment and transfer services"
  },
  {
    ...
    period: "agreement",
    rating: 4.8,
    description: "Patent licensing agreement drafting and filing"
  },
  {
    ...
    period: "year",
    rating: 4.8,
    description: "Complete patent portfolio management services"
  },
  {
    ...
    period: "analysis",
    rating: 4.8,
    description: "Patent infringement analysis and freedom to operate studies"
  }
];
