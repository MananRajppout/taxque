...
// Service data for Non-Individual Startup
const nonIndividualStartupServices = [
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Complete private limited company registration and incorporation"
  },
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Limited Liability Partnership registration and setup"
  },
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Partnership firm registration and compliance setup"
  },
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "One Person Company (OPC) registration and incorporation"
  },
  {
    ...
    period: "one-time", 
    rating: 4.8,
    description: "GST registration for corporate entities and businesses"
  },
  {
    title: "Corporate Compliance Package",
    basicPrice: "4599",
    price: "2999",
    period: "year",
    rating: 4.8,
    description: "Complete compliance package for corporate startups"
  },
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Current account opening assistance for corporate entities"
  },
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Corporate tax registration and compliance setup"
  }
];
        ...
        <div className="flex items-start gap-4 mb-4">
          <div className="w-12 h-12 bg-green-200 rounded-lg flex items-center justify-center flex-shrink-0">
            <Image
              ...
              alt="Non-Individual Startup Icon"
              width={24}
              height={24}
              className="w-6 h-6"
            />
...
export default function NonIndividualStartupPage() {
      ...
      <div className="px-4 md:px-8 lg:px-16 pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center text-gray-900 mb-12">
            Non-Individual Startup Services
          </h1>

          {/* Service Cards Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {nonIndividualStartupServices.map((service, index) => (
