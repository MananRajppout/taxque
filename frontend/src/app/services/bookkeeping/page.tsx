...
const bookkeepingServices = [
  {
    ...
    period: "month",
    rating: 4.8,
    description: "Complete monthly bookkeeping and accounting services"
  },
  {
    ...
    period: "quarter",
    rating: 4.8,
    description: "Quarterly bookkeeping and financial record maintenance"
  },
  {
    ...
    period: "year",
    rating: 4.8,
    description: "Annual bookkeeping and year-end financial closure"
  },
  {
    ...
    period: "month",
    rating: 4.8,
    description: "Accounts payable management and vendor payment processing"
  },
  {
    ...
    period: "month", 
    rating: 4.8,
    description: "Accounts receivable management and customer invoicing"
  },
  {
    ...
    period: "month",
    rating: 4.8,
    description: "Monthly bank reconciliation and statement matching"
  },
  {
  ...
  },
  {
    ...
    period: "month",
    rating: 4.8,
    description: "Complete payroll processing and employee payment services"
  },
  {
