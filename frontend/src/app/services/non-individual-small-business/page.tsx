...
// Service data for Non-Individual and Small Business Compliance
const nonIndividualSmallBusinessServices = [
  {
    title: "Corporate Compliance Setup",
    basicPrice: "4599",
    price: "2999",
    period: "one-time",
    rating: 4.8,
    description: "Complete compliance setup for corporate entities and businesses"
  },
  {
    ...
    period: "year",
    rating: 4.8,
    description: "Corporate tax compliance and filing services"
  },
  {
    ...
    period: "year",
    rating: 4.8,
    description: "GST compliance services for corporate entities"
  },
  {
    title: "Corporate Business License",
    basicPrice: "4599",
    price: "2999", 
    period: "one-time",
    rating: 4.8,
    description: "Business license and permits for corporate entities"
  },
  {
    ...
    period: "month", 
    rating: 4.8,
    description: "Professional accounting services for corporate entities"
  },
  {
    ...
    period: "audit",
    rating: 4.8,
    description: "Compliance audit and assessment for corporate entities"
  },
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Complete documentation services for corporate entities"
  },
  {
    ...
    period: "consultation",
    rating: 4.8,
    description: "Financial planning and advisory services for corporate entities"
  },
  {
    ...
    period: "year",
    rating: 4.8,
    description: "Corporate secretarial services and compliance management"
  }
];
        ...
        <div className="flex items-start gap-4 mb-4">
          <div className="w-12 h-12 bg-green-200 rounded-lg flex items-center justify-center flex-shrink-0">
            <Image
              ...
              alt="Non-Individual Small Business Icon"
              width={24}
              height={24}
              className="w-6 h-6"
            />
...
export default function NonIndividualSmallBusinessPage() {
      ...
      <div className="px-4 md:px-8 lg:px-16 pt-20 pb-4">
        <div className="max-w-7xl mx-auto">
          <nav className="text-sm text-orange-500 mb-6">
            ...
            <span className="text-gray-600">Compliance Services</span>
          </nav>
        </div>
      </div>
      ...
      <div className="px-4 md:px-8 lg:px-16 pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center text-gray-900 mb-12">
            Non-Individual and Small Business Compliance
          </h1>

          {/* Service Cards Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {nonIndividualSmallBusinessServices.map((service, index) => (
