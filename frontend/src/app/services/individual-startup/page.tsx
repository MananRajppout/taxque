...
// Service data for Individual Startup
const individualStartupServices = [
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Complete sole proprietorship registration and compliance setup"
  },
  {
    title: "Individual GST Registration", 
    basicPrice: "4599",
    price: "2999",
    period: "one-time",
    rating: 4.8,
    description: "GST registration for individual entrepreneurs and freelancers"
  },
  {
    title: "Individual Income Tax Setup", 
    basicPrice: "4599", 
    price: "2999",
    period: "one-time",
    rating: 4.8,
    description: "Income tax registration and compliance setup for individuals"
  },
  {
  ...
  {
    title: "Individual Bank Account Setup",
    basicPrice: "4599",
    price: "2999",
    period: "one-time", 
    rating: 4.8,
    description: "Current account opening assistance for individual businesses"
  },
  {
    title: "Individual Compliance Package",
    basicPrice: "4599",
    price: "2999",
    period: "year",
    rating: 4.8,
    description: "Complete compliance package for individual startups"
  }
];
...
export default function IndividualStartupPage() {
      ...
      <div className="px-4 md:px-8 lg:px-16 pt-20 pb-4">
        <div className="max-w-7xl mx-auto">
          <nav className="text-sm text-orange-500 mb-6">
            ...
            <span className="text-gray-600">Startup Services</span>
          </nav>
        </div>
      </div>
      ...
      <div className="px-4 md:px-8 lg:px-16 pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center text-gray-900 mb-12">
            Individual Startup Services
          </h1>

          {/* Service Cards Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {individualStartupServices.map((service, index) => (
