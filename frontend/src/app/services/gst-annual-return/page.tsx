...
// Service data for GST Annual Return
const gstAnnualServices = [
  {
    ...
    period: "month",
    rating: 4.8,
    description: "Annual GST return filing for regular taxpayers (GSTR-9)"
  },
  {
    title: "GST Annual Return - GSTR-9A", 
    basicPrice: "4599",
    price: "2999",
    period: "month",
    rating: 4.8,
    description: "Annual GST return filing for composition taxpayers (GSTR-9A)"
  },
  {
    title: "GST Annual Return - GSTR-9B",
    basicPrice: "4599", 
    price: "2999",
    period: "month",
    rating: 4.8,
    description: "Annual GST return filing for e-commerce operators (GSTR-9B)"
  },
  {
    ...
    period: "month",
    rating: 4.8,
    description: "Annual GST return with reconciliation statement (GSTR-9C)"
  }
];
      ...
      <div className="px-4 md:px-8 lg:px-16 pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {gstAnnualServices.map((service, index) => (
