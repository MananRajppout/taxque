...
// Service data for LUT Filing
const lutFilingServices = [
  {
    title: "LUT Filing - Export of Goods",
    basicPrice: "4599",
    price: "2999",
    period: "month",
    rating: 4.8,
    description: "Letter of Undertaking filing for export of goods without payment of IGST"
  },
  {
    title: "LUT Filing - Export of Services", 
    basicPrice: "4599",
    price: "2999",
    period: "month",
    rating: 4.8,
    description: "Letter of Undertaking filing for export of services without payment of IGST"
  },
  {
    title: "LUT Filing - SEZ Supplies", 
    basicPrice: "4599", 
    price: "2999",
    period: "month",
    rating: 4.8,
    description: "Letter of Undertaking filing for supplies to Special Economic Zones"
  },
  {
    title: "LUT Filing - Bond Submission",
    basicPrice: "4599",
    price: "2999", 
    period: "month",
    rating: 4.8,
    description: "Bond submission for export transactions under LUT scheme"
  },
  {
    title: "LUT Filing - Amendment Services",
    basicPrice: "4599",
    price: "2999",
    period: "month", 
    rating: 4.8,
    description: "Amendment services for existing Letter of Undertaking"
  },
  {
    title: "LUT Filing - Renewal Services",
    basicPrice: "4599",
    price: "2999",
    period: "month",
    rating: 4.8,
    description: "Renewal services for Letter of Undertaking before expiry"
  }
];
...
export default function LUTFilingPage() {
      ...
      <div className="px-4 md:px-8 lg:px-16 pt-20 pb-4">
        <div className="max-w-7xl mx-auto">
          <nav className="text-sm text-orange-500 mb-6">
            ...
            <span className="text-gray-600">Goods and Services Tax (GST)</span>
          </nav>
        </div>
      </div>
      ...
      <div className="px-4 md:px-8 lg:px-16 pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {lutFilingServices.map((service, index) => (
