...
// Service data for Individual and Small Business Compliance
const individualSmallBusinessServices = [
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Complete registration and compliance setup for small businesses"
  },
  {
    ...
    period: "year",
    rating: 4.8,
    description: "Individual tax compliance and filing services"
  },
  {
    title: "Small Business GST Compliance", 
    basicPrice: "4599", 
    price: "2999",
    period: "year",
    rating: 4.8,
    description: "GST compliance services for small businesses"
  },
  {
    title: "Individual Business License",
    basicPrice: "4599",
    price: "2999", 
    period: "one-time",
    rating: 4.8,
    description: "Business license and permits for individual entrepreneurs"
  },
  {
    ...
    period: "month", 
    rating: 4.8,
    description: "Professional accounting services for small businesses"
  },
  {
    title: "Individual Compliance Audit",
    basicPrice: "4599",
    price: "2999",
    period: "audit",
    rating: 4.8,
    description: "Compliance audit and assessment for individuals"
  },
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Complete documentation services for small businesses"
  },
  {
    ...
    period: "consultation",
    rating: 4.8,
    description: "Financial planning and advisory services for individuals"
  }
];
        ...
        <div className="flex items-start gap-4 mb-4">
          <div className="w-12 h-12 bg-green-200 rounded-lg flex items-center justify-center flex-shrink-0">
            <Image
              ...
              alt="Individual Small Business Icon"
              width={24}
              height={24}
              className="w-6 h-6"
            />
...
export default function IndividualSmallBusinessPage() {
      ...
      <div className="px-4 md:px-8 lg:px-16 pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {individualSmallBusinessServices.map((service, index) => (
