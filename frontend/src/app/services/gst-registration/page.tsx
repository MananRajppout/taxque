...
// Service data for GST Registration
const gstRegistrationServices = [
  {
    title: "GST Registration - New Business",
    basicPrice: "4599",
    price: "2999",
    period: "month",
    rating: 4.8,
    description: "Complete GST registration for new businesses and startups"
  },
  {
    title: "GST Registration - Existing Business", 
    basicPrice: "4599",
    price: "2999",
    period: "month",
    rating: 4.8,
    description: "GST registration for existing businesses migrating to GST"
  },
  {
    title: "GST Registration - Composition Scheme",
    basicPrice: "4599", 
    price: "2999",
    period: "month",
    rating: 4.8,
    description: "GST registration under composition scheme for small businesses"
  },
  {
    title: "GST Registration - Casual Taxable Person",
    basicPrice: "4599",
    price: "2999", 
    period: "month",
    rating: 4.8,
    description: "GST registration for casual taxable persons and seasonal businesses"
  },
  {
    title: "GST Registration - Non-Resident Taxable Person",
    basicPrice: "4599",
    price: "2999",
    period: "month", 
    rating: 4.8,
    description: "GST registration for non-resident taxable persons"
  },
  {
    ...
    period: "month",
    rating: 4.8,
    description: "Amendment services for existing GST registration details"
  }
];
      ...
      <div className="px-4 md:px-8 lg:px-16 pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {gstRegistrationServices.map((service, index) => (
