...
const trademarkServices = [
  {
    ...
    period: "one-time",
    rating: 4.8,
    description: "Complete trademark registration and filing services"
  },
  {
    ...
    period: "search",
    rating: 4.8,
    description: "Comprehensive trademark search and availability check"
  },
  {
    ...
    period: "renewal",
    rating: 4.8,
    description: "Trademark renewal and maintenance services"
  },
  {
    ...
    period: "case",
    rating: 4.8,
    description: "Trademark opposition filing and legal representation"
  },
  {
    ...
    period: "one-time", 
    rating: 4.8,
    description: "Trademark assignment and transfer services"
  },
  {
    ...
    period: "agreement",
    rating: 4.8,
    description: "Trademark licensing agreement drafting and filing"
  },
  {
    ...
    period: "year",
    rating: 4.8,
    description: "Trademark monitoring and infringement detection"
  },
  {
    ...
    period: "year",
    rating: 4.8,
    description: "Complete trademark portfolio management services"
  }
];
