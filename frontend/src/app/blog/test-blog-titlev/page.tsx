...
const blogImg = "/assests/images/oslImg1.png";
...
export default function TestBlogTitlevPage() {
      ...
      <div className="px-4 md:px-8 lg:px-16 pt-20 pb-4">
        <div className="max-w-7xl mx-auto">
          <nav className="text-sm text-orange-500 mb-6">
            ...
            <span className="mx-2">&gt;</span>
            <span className="text-gray-600">Test blog titlev</span>
          </nav>
        </div>
      </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex items-center gap-2 text-orange-500">
                  ...
                  <span className="text-sm font-medium">15/04/2025</span>
                </div>
              </div>
              ...
              <div className="prose prose-lg max-w-none">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Understanding Tax Implications</h2>
                <p className="text-gray-600 leading-relaxed mb-6">
                  Tax implications are crucial for every business and individual. Understanding the various tax structures, deductions, and compliance requirements can help you make informed financial decisions and avoid penalties.
                </p>

                <h2 className="text-2xl font-bold text-gray-900 mb-4">Key Tax Considerations</h2>
                <p className="text-gray-600 leading-relaxed mb-6">
                  When planning your finances, consider factors like income tax brackets, GST implications, TDS requirements, and annual return filing deadlines. Proper planning can help optimize your tax liability while staying compliant with regulations.
                </p>

                <p className="text-gray-600 leading-relaxed">
                  It's essential to stay updated with the latest tax reforms and regulatory changes. Regular consultation with tax professionals and using reliable tax calculation tools can ensure accurate compliance and optimal tax planning.
                </p>
              </div>
            </div>
