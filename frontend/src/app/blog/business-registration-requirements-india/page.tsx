...
const HPTImg = "/assests/images/BRCardImg.png";
      ...
      <div className="px-4 md:px-8 lg:px-16 pt-20 pb-4">
        <div className="max-w-7xl mx-auto">
          <nav className="text-sm text-orange-500 mb-6">
            ...
            <span className="hover:text-orange-600 cursor-pointer" onClick={() => router.push('/blog')}>Registration</span>
            <span className="mx-2">&gt;</span>
            <span className="text-gray-600">Business Registration Requirements in India</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-8">
                Business Registration Requirements in India
              </h1>
              ...
              <div className="prose prose-lg max-w-none">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Types of Business Registration</h2>
                <p className="text-gray-600 leading-relaxed mb-6">
                  In India, businesses can be registered under various forms including Private Limited Company, Public Limited Company, Limited Liability Partnership (LLP), One Person Company (OPC), Partnership Firm, and Sole Proprietorship. Each structure has its own advantages, compliance requirements, and legal obligations.
                </p>

                <h2 className="text-2xl font-bold text-gray-900 mb-4">Essential Documents</h2>
                <p className="text-gray-600 leading-relaxed mb-6">
                  The key documents required for business registration include PAN card, Aadhaar card, identity proof of all directors/partners, address proof of the registered office, passport-sized photographs, and a No Objection Certificate (NOC) from the property owner. Additionally, you'll need bank statements, cancelled cheque, and digital signature certificates for company registration.
                </p>

                <h2 className="text-2xl font-bold text-gray-900 mb-4">Registration Process</h2>
                <p className="text-gray-600 leading-relaxed mb-6">
                  The registration process begins with obtaining a DSC (Digital Signature Certificate) and DPIN (Director Identification Number). Next, apply for name reservation through RUN (Reserve Unique Name) or use the SPICe+ form for incorporation. Once the name is approved, submit the incorporation documents along with MOA (Memorandum of Association) and AOA (Articles of Association).
                </p>

                <h2 className="text-2xl font-bold text-gray-900 mb-4">Post-Registration Compliances</h2>
                <p className="text-gray-600 leading-relaxed mb-6">
                  After successful registration, businesses must obtain GST registration, open a business bank account, get a professional tax registration (if applicable), and register for ESIC and EPF if they have employees. Annual compliance includes filing annual returns, board meetings, and audit requirements based on turnover.
                </p>

                <p className="text-gray-600 leading-relaxed">
                  Understanding these requirements helps ensure smooth business registration and ongoing compliance. Proper planning and documentation are crucial for successful business setup in India.
                </p>
              </div>
            </div>
              ...
              <div className="p-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed mb-3">Professional company registration services</p>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-green-200 hover:-translate-y-1">
              <div className="p-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-lg font-bold text-gray-900 mb-2 leading-tight">LLP Registration</h3>
                    <p className="text-sm text-gray-600 leading-relaxed mb-3">Limited Liability Partnership registration</p>
                    <button className="w-24 bg-white border-2 border-orange-500 hover:bg-orange-50 text-orange-500 hover:text-orange-600 font-semibold py-1.5 px-3 rounded-md transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 text-sm">
                      Read More
                    </button>
                  </div>
